...
public class PayBillProcedure {

	JdbcTemplate jdbcTemplate = ConnectionUtil.getJdbcTemplate();
	public String PayBill(int orderid,int seat,String mess) {
		SimpleJdbcCall call = new SimpleJdbcCall(jdbcTemplate).withProcedureName("pay_bill").declareParameters(
